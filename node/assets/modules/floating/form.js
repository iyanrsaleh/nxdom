      ...
      <form id="myForm" class="nx-row">
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
            <dl>
              <dt class="form-group-header">
                <label for="tagsSelect2">${getIcon("select2")}Technology Tags (Select2)</label>
              </dt>
              <dd class="form-group-body">
                <select id="tagsSelect2" class="js-select2" name="tags" multiple required data-placeholder="Pilih tags" data-allow-clear="true" style="width:100%">
                ...
                <p class="note">Contoh select2 searchable + multiple tags.</p>
              </dd>
            </dl>
          </div>
        </div>
        ...
        <div class="col-12 col-md-6">
          <div class="form-group">
            <dl>
              ...
              <dd class="form-group-body">
                <div class="form-checkbox"><label><input type="radio" name="gender" value="pria" required /> Pria</label></div>
                <div class="form-checkbox"><label><input type="radio" name="gender" value="wanita" /> Wanita</label></div>
                <div class="form-checkbox"><label><input type="radio" name="gender" value="lainnya" /> Lainnya</label></div>
              </dd>
            </dl>
          </div>
        </div>
            ...
            <dl>
              ...
              <dd class="form-group-body">
                <label for="foto-input" class="file-upload-area" id="foto-drop">
                  <!-- Komponen upload file akan di-generate oleh NexaFloating/_fileFields.js -->
                </label>
