...
class NexaModels {
  constructor(secretKey = "nexa-default-secret-key-2025") {
    ...
    // Inisialisasi NexaFetch: cukup turunan dari API_URL (satu sumber endpoint)
    // Model routing diarahkan ke OutsideController::index
    this.apiClient = new NexaFetch({
      baseURL: Server.API_URL + "/outside"
    });
    // Pengaturan keamanan
